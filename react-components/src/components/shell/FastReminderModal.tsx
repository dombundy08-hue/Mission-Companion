...
// First pop-up of the day on an active fast day — reminds you what you
...
export function FastReminderModal({ intention, onClose }: { intention: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={handleClose}>
      ...
      >
        <h3 className="mb-1 font-heading text-lg font-semibold" style={{ color: 'var(--foreground)' }}>🕊️ Fasting</h3>
